...
- построение dossier
- outline доклада и storyboard слайдов
- mock-защита с follow-up вопросами и разбором слабых мест

Чего не стоит обещать без оговорки:
- это первая рабочая версия DLC
