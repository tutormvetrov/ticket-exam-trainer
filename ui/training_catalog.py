...
DEFAULT_TRAINING_MODES = [
    ...
    TrainingModeData("active-recall", "Active Recall", "Сначала вопрос, потом ответ", "◌", "#F2FCF7", "#37C887"),
    TrainingModeData("cloze", "Cloze Deletion", "Заполните пропуски в тексте", "□", "#F8F3FF", "#8D68F3"),
