...
TRAINING_MODE_SPECS: dict[str, TrainingModeSpec] = {
    ...
    "state-exam-full": TrainingModeSpec(
        key="state-exam-full",
        title="Полный госответ",
        workspace_title="Полный ответ по структуре госэкзамена",
        workspace_hint="Ответьте по шести блокам рубрики и сразу увидьте, какие части ответа у вас проседают.",
        empty_title="Нет билета с профилем госэкзамена",
        empty_body="Для этого режима нужен билет, импортированный с профилем «Госэкзамен».",
    ),
